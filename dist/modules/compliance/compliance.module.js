    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: checklist_schema_1.Checklist.name, schema: checklist_schema_1.ChecklistSchema },
                { name: checklist_schema_1.ChecklistSubmission.name, schema: checklist_schema_1.ChecklistSubmissionSchema },
            ]),
        ],

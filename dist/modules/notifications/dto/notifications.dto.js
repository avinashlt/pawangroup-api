...
exports.BroadcastDto = exports.CreateNotificationDto = void 0;
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['alert', 'info', 'warning', 'success', 'sos', 'incident', 'attendance', 'geofence'] }),
    (0, class_validator_1.IsEnum)(['alert', 'info', 'warning', 'success', 'sos', 'incident', 'attendance', 'geofence']),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['alert', 'info', 'warning', 'success'] }),
    (0, class_validator_1.IsEnum)(['alert', 'info', 'warning', 'success']),
    __metadata("design:type", String)

    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                ...
                { name: shift_schema_1.ShiftSwapRequest.name, schema: shift_schema_1.ShiftSwapRequestSchema },
                { name: shift_schema_1.TimeOffRequest.name, schema: shift_schema_1.TimeOffRequestSchema },
            ]),
        ],
